...
const CourseDetails = () => {
    ...
    try {
       ...
       if(isAlreadyEnrolled){
        ...
        const {data} = await axios.post(
          backendUrl + '/api/user/purchase', {courseId: courseData._id}, {headers : {
  ...
  useEffect(() => {
    if(userData && courseData){
      setCourseData(userData.enrolledCourses.includes(courseData._id))
    }
  }, [userData, courseData]);
  ...
  return courseData ? (
    <>
      ...
      >
        ...
        {/* {right column} */}
        <div
          className="max-w-[424px] z-10 shadow-[0px_4px_15px_2px_rgba(0,_0,_0,_0.1)] rounded-t 
          md:rounded-none overflow-hidden bg-white min-w-[250px] sm:min-w-[420px]"
        >
          {playerData ? (
            <YouTube
          ...
          <div className="p-5">
            ...
            <button onClick={enrolledCourses} className="md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium">
              {isAlreadyEnrolled ? "Already Enrolled" : "Enroll Now"}
            </button>

            <div className="pt-6">
              <p className="md:text-xl text-lg group-indeterminate: text-gray-800">
                What's in the course
              </p>
              <ul className="ml-4 pt-2 text-sm md:text-[15px] list-disc text-gray-500">
                <li>Life access with free updates.</li>
